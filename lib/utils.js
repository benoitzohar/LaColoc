...
/**
 * Get the rounded float version of an int
 *
 * @param {int} v
 * @param {int} d Decimal to use - optional (default:100)
 * @return {int}
 * @api public
 */
 
exports.roundFloat = function(v,d) {
    if (d) return parseInt(d*v,10)/d;
    return parseInt(100*v,10)/100;
};

exports.sendJSON = function(res, err, data) {
