 ...
 * @type {angular.Module}
 */
lca = angular.module('lacoloc', ['ui.router', 'ngCookies', 'ui.bootstrap', 'oitozero.ngSweetAlert'])
    ...
    .config(function($stateProvider) {
        ...
        $stateProvider.state({
            name: 'groups-new',
            url: '/groups/new/:isModal',
            templateUrl: function(args) {
                return '/groups/new/' + args.isModal;
            },
